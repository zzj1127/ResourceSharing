...
<div id="menu"><!--菜单-->
    ...
    <ul>
        ...
        <li class="nav_site menu_cur"><a href="/tofindResourcesByUseridPh?userId=${user1.userId} "><i></i><span>我的资源</span><b></b><div class="clear"></div></a></li>
...
<c:if test="${empty user1}">
        <div class="wrap">
            <center>
     <p style="font-size:80px;">还未登陆</p></center>
        </div>
</c:if>
<c:if test="${!empty user1}">
        <div id="list">
